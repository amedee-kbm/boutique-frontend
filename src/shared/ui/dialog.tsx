...
function DialogTrigger({
  ...
  return (
    <DialogPrimitive.Trigger data-slot="dialog-trigger" asChild={asChild || !!render} {...props}>
...
function DialogClose({
  ...
  return (
    <DialogPrimitive.Close data-slot="dialog-close" asChild={asChild || !!render} {...props}>
      {render ? render : children}
