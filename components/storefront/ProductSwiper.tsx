...
import { bagKey, useBag } from '@/lib/bag/useBag'
...
import { firstColourId, type ProductDetailData } from '@/lib/storefront/product-detail'
...
export function ProductSwiper({
  ...
  function addLine(size: string | null) {
    ...
    const colour = activeData.colours.find((c) => c.optionId === colourId) ?? null
    add({
